    ...
    return(
            ...
            <ScrollView>
                <View style={styles.LoginView}>
                    ...
                    <Text h4 style={{textTransform:'uppercase'}}>Admin Dashboard</Text>
                    <View style={{height:10}}></View>

               </View>

               <View style={{flexDirection:"row", justifyContent:'space-evenly', paddingTop:20, paddingBottom:20}}>
                    <TouchableOpacity onPress={()=> props.navigation.navigate('AdminViewBill')} >
                    ...
                    <TouchableOpacity onPress={()=> props.navigation.navigate('AdminViewUser')} >
                        <View style={{backgroundColor:'white', padding:30, borderRadius:10, alignItems:'center', width:160}} >
                            <Avatar
                                rounded
                                size="large"
