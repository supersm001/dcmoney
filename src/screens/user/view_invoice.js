...
import {GetLoggedInUserSpecEmiBillDetails} from '../../services/api/users/userapi'
...
export const UserSpecficInvoiceDetails = (props) => { 
    ...
    async function getfuncion(id){
        ...
        if(InvType == 'invoice')
            setInvoiceUrl('SOSINVOICE'+res[1][0].invoice_id+'.pdf')
        else
            setInvoiceUrl('SOSEMIINVOICE'+res[1][0].emi_invoice_id+'.pdf')
    }
