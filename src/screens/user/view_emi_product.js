                ...
                renderItem={({item})=>{
                    ...
                    <View>
                        ...
                        <View style={styles.viewStyle}>
                            ...
                            <Button onPress={()=> props.navigation.navigate('UserSpecficInvoiceDetails', [{id:EmiDetails[0].bill_id, type:'emi_invoice'}])} title='View Invoice' containerStyle={{marginTop:50}} buttonStyle={{borderRadius:100, padding:10}} />
